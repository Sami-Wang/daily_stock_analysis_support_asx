...
> 🤖 基于 AI 大模型的 A股/港股/美股/澳股自选股智能分析系统，每日自动分析并推送「决策仪表盘」到企业微信/飞书/Telegram/Discord/Slack/邮箱
...
| 市场 | 全球市场 | 支持 A股、港股、美股、美股指数（SPX、DJI、IXIC 等）及澳股 |
...
> 注：美股历史数据与实时行情统一使用 YFinance，确保复权一致性；澳股数据同样通过 YFinance 获取
